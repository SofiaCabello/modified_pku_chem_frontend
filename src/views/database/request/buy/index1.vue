<template>
  ...
  <div class="unfinished-container">
    ...
    <pagination v-show="total>0" :total="total" :page.sync="hazardQuery.page" :limit.sync="hazardQuery.limit" @pagination="getList" />
...
export default{
  ...
  methods:{
    getList(){
      ...
      getUnfinished(this.hazardQuery).then(response => {
    ...
    handleDrugChange(selectedData){
      // 选择药物后的回调，将选择药物的id数组赋值给hazardQuery.drugID
      this.hazardQuery.drugID = selectedData
    },
